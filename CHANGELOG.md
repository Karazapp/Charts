...
- Cannot find "@import IOSCharts;" in -Swift.h, I can only @import IOSCharts in OC files, anything I missed? [\#4021](https://github.com/danielgindi/Charts/issues/4021)
...
- if use pod Charts/Realm ,than @import IOSCharts: could not build module "Charts" [\#917](https://github.com/danielgindi/Charts/issues/917)
- @import IOSCharts: could not build module "Charts" [\#916](https://github.com/danielgindi/Charts/issues/916)
...
- import IOSCharts: Error No Such Module Charts? [\#818](https://github.com/danielgindi/Charts/issues/818)
